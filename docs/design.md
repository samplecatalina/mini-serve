...
Status: M0 and M1 complete; M2 in progress (radix prefix cache measured). Numbers will appear in `results/` and be discussed in `optimization-log.md` as they are measured.
